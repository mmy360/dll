...
class LeNet(Module):
    """
    LeNet-5, NIPS 1998
    Titile: Gradient-Based Learning Applied to Document Recognition
    ...
    def __init__(self, num_classes=10):
        ...
        self.net = nn.Sequential(
            nn.Conv2d(1, 6, kernel_size=5, padding=2), # Conv Layer 1
            nn.Sigmoid(),
            nn.AvgPool2d(kernel_size=2, stride=2),     # Pooling Layer 1
            nn.Conv2d(6, 16, kernel_size=5),           # Conv Layer 2
            nn.Sigmoid(),
            nn.AvgPool2d(kernel_size=2, stride=2),     # Pooling Layer 2
            nn.Flatten(),
            nn.Linear(16*5*5, 120),                    # Fully Connected Layer 1
            nn.Sigmoid(),
            nn.Linear(120, 84),                        # Fully Connected Layer 2
            nn.Sigmoid(),
            nn.Linear(84, num_classes)                 # Fully Connected Layer 3
        )
...
class PositionalEncoding(nn.Module):  #@save
    ...
    def __init__(self, num_hiddens, dropout, max_len=1000):
        ...
        X = np.arange(max_len, dtype=torch.float32).reshape(
